...
namespace NhaHang.Infrastructure.Extensions
{
    public static class QueryableExtensions
    {
        ...
        public static IQueryable<T> WhereByName<T>(this IQueryable<T> source, string propertyName, string operatorFilter, object value)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
            ...
            ////var methodName = isDescending ? "OrderByDescending" : "OrderBy";
            //object result = typeof(Queryable).GetMethods().Single(
            //	method => method.Name == operatorFilter
            //			&& method.IsGenericMethodDefinition
            //			&& method.GetGenericArguments().Length == 2
            //			&& method.GetParameters().Length == 2
            ...
            object result = typeof(Queryable).FindMembers;
            return (IQueryable<T>)result;
        }
    }
}