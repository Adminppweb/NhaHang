    ...
    angular.module('simplAdmin.contacts', [])
        .config(['$stateProvider', function ($stateProvider) {
            $stateProvider
                .state('contact-area', {
                    url: '/contact-area',
                    templateUrl: '_content/NhaHang.Module.Contacts/admin/contact-area/contact-area-list.html',
                    controller: 'ContactAreaListCtrl as vm'
                })
                .state('contact-area-create', {
                    url: '/contact-area/create',
                    templateUrl: '_content/NhaHang.Module.Contacts/admin/contact-area/contact-area-form.html',
                ...
                .state('contact-area-translation', {
                    ...
                    templateUrl: '_content/NhaHang.Module.Contacts/admin/contact-area/contact-area-translation-form.html',
                    controller: 'ContactAreaTranslationFormCtrl as vm'
                })
                .state('contact', {
                    url: '/contact',
                    templateUrl: '_content/NhaHang.Module.Contacts/admin/contacts/contact-list.html',
