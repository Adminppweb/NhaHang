...
(function () {
    ...
    function ContactAreaListCtrl(contactAreaService, translateService, $window) {
        ...
        vm.deleteContactArea = function deleteContactArea(contactArea) {
            bootbox.confirm(translateService.get('Are you sure you want to delete this Contact Area: ') + simplUtil.escapeHtml(contactArea.name), function (result) {
                if (result) {
                    contactAreaService.deleteContactArea(contactArea)
                       .then(function (result) {
                           vm.getContactAreas();
                           toastr.success(contactArea.name + translateService.get(' has been deleted'));
                       })
