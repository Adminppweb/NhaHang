...
{
    public class SimplBrazorDbContext
    ...
    ///: DbContext
    {
        public SimplBrazorDbContext(DbContextOptions<SimplBrazorDbContext> options) : base(options)
        {
        }

        //public SimplBrazorDbContext(DbContextOptions options) : base(options)
        //{
        //}
