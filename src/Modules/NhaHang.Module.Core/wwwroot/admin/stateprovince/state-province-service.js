...
(function () {
    ...
    function stateProvinceService($http) {
        ...
        function editStateProvince(stateProvince) {
            return $http.post('api/states-provinces/update-state-province/' + stateProvince.id, stateProvince);
        }
        ...
        function deleteStateProvince(stateProvince) {
            return $http.post('api/states-provinces/delete-state-province/' + stateProvince.id, null);
        }
    }
})();
