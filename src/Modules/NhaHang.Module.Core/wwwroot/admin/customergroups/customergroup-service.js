...
(function () {
    ...
    function customergroupService($http) {
        ...
        function editCustomerGroup(customergroup) {
            return $http.post('api/customergroups/update-customer-group/' + customergroup.id, customergroup);
        }

        function deleteCustomerGroup(customergroup) {
            return $http.post('api/customergroups/delete-customer-group/' + customergroup.id, null);
        }
    }
})();
