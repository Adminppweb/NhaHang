        ...
        .config(['$stateProvider',
            function ($stateProvider) {
                $stateProvider
                    .state('cart-rules', {
                        url: '/cart-rules',
                        templateUrl: '_content/NhaHang.Module.Pricing/admin/cart-rule/cart-rule-list.html',
                        controller: 'CartRuleListCtrl as vm'
                    })
                    .state('cart-rule-create', {
                        url: '/cart-rule/create',
                        templateUrl: '_content/NhaHang.Module.Pricing/admin/cart-rule/cart-rule-form.html',
                    ...
                    .state('cart-rule-usages', {
                        ...
                        templateUrl: '_content/NhaHang.Module.Pricing/admin/cart-rule-usage/cart-rule-usage-list.html',
