...
using NhaHang.Module.Pricing.Areas.Pricing.ViewModels;
using NhaHang.Module.Pricing.Models;

namespace NhaHang.Module.Pricing.Areas.Pricing.Controllers
{
    [Area("Pricing")]
    ...
    public class CartRuleApiController : Controller
    {
        ...
        public async Task<IActionResult> Delete(long id)
        {
            ...
            {
                return BadRequest(new { Error = $"Không thể xóa quy tắc giỏ hàng {cartRule.Name} vì nó đã được sử dụng" });
            }
