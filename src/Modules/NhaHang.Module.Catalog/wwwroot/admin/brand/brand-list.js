...
(function () {
    ...
    function BrandListCtrl(brandService, translateService) {
        ...
        vm.deleteBrand = function deleteBrand(brand) {
            bootbox.confirm(translateService.get('Are you sure you want to delete this brand: ') + simplUtil.escapeHtml(brand.name), function (result) {
                if (result) {
                    brandService.deleteBrand(brand)
                       .then(function (result) {
                           vm.getBrands();
                           toastr.success(brand.name + translateService.get(' has been deleted'));
                       })
