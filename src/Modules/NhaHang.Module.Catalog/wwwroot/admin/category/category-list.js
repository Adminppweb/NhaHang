...
(function () {
    ...
    function CategoryLitsCtrl(categoryService, translateService, $window) {
        ...
        vm.deleteCategory = function deleteCategory(category) {
            bootbox.confirm(translateService.get('Are you sure you want to delete this category: ') + simplUtil.escapeHtml(category.name), function (result) {
                if (result) {
                    categoryService.deleteCategory(category)
                       .then(function (result) {
                           vm.getCategories();
                           toastr.success(category.name + translateService.get(' has been deleted'));
                        })
