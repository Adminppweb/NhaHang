...
(function () {
    ...
    function productService($http, Upload) {
        ...
        function editProduct(product, thumbnailImage, productImages, productDocuments) {
            return Upload.upload({
                url: 'api/products/update-product/' + product.id,
                method: 'POST',
                data: {
                    product: product,
                    thumbnailImage: thumbnailImage,
        ...
        function deleteProduct(product) {
            return $http.post('api/products/delete-product/' + product.id, null);
        }
        ...
        function editProductTranslation(id, culture, model) {
            return $http.post('api/product-translations/update-product-translation/' + id + '?culture=' + culture, model);
        }
    }
})();
