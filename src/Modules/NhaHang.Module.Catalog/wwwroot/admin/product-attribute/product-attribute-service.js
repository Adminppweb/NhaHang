...
(function () {
    ...
    function productAttributeService($http) {
        ...
        function editProductAttribute(productAttribute) {
            return $http.post('api/product-attributes/update-product-attribute/' + productAttribute.id, productAttribute);
        }

        function deleteProductAttribute(productAttribute) {
            return $http.post('api/product-attributes/delete-product-attribute/' + productAttribute.id, null);
        }
    }
})();
