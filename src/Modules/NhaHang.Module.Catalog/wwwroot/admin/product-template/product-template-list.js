...
(function () {
    ...
    function ProductTemplateListCtrl(productTemplateService, translateService) {
        ...
        vm.deleteProductTemplate = function deleteProductTemplate(productTemplate) {
            bootbox.confirm(translateService.get('Are you sure you want to delete this template: ') + simplUtil.escapeHtml(productTemplate.name), function (result) {
                if (result) {
                    productTemplateService.deleteProductTemplate(productTemplate)
                       .then(function (result) {
                           vm.getProductTemplates();
                           toastr.success(productTemplate.name + translateService.get(' has been deleted'));
                       })
