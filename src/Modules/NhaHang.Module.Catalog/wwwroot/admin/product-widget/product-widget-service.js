...
(function () {
    angular
        ...
        .factory('productWidgetService', ['$http', 'Upload', productWidgetService]);
    ...
    function productWidgetService($http, Upload) {
        ...
        function editProductWidget(widgetInstance) {
            return $http.post('api/product-widgets/update-product-widget/' + widgetInstance.id, widgetInstance);
        }
