    ...
    angular.module('simplAdmin.catalog', [])
        .config(['$stateProvider', function ($stateProvider) {
            $stateProvider
                .state('brand', {
                    url: '/brand',
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/brand/brand-list.html',
                    controller: 'BrandListCtrl as vm'
                })
                .state('brand-create', {
                    url: '/brand/create',
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/brand/brand-form.html',
                ...
                .state('category', {
                    url: '/category',
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/category/category-list.html',
                    controller: 'CategoryListCtrl as vm'
                })
                .state('category-create', {
                    url: '/category/create',
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/category/category-form.html',
                ...
                .state('category-translation', {
                    ...
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/category/category-translation-form.html',
                    controller: 'CategoryTranslationFormCtrl as vm'
                })
                .state('product-option', {
                    url: '/product-option',
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/product-option/product-option-list.html',
                    controller: 'ProductOptionListCtrl as vm'
                })
                .state('product-option-create', {
                    url: '/product-option/create',
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/product-option/product-option-form.html',
                ...
                .state('product-attribute-group', {
                    ...
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/product-attribute-group/product-attribute-group-list.html',
                    controller: 'ProductAttributeGroupListCtrl as vm'
                })
                .state('product-attribute-group-create', {
                    url: '/product-attribute-group/create',
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/product-attribute-group/product-attribute-group-form.html',
                ...
                .state('product-attribute', {
                    ...
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/product-attribute/product-attribute-list.html',
                    controller: 'ProductAttributeListCtrl as vm'
                })
                .state('product-attribute-create', {
                    url: '/product-attribute/create',
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/product-attribute/product-attribute-form.html',
                ...
                .state('product-template', {
                    ...
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/product-template/product-template-list.html',
                    controller: 'ProductTemplateListCtrl as vm'
                })
                .state('product-template-create', {
                    url: '/product-template/create',
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/product-template/product-template-form.html',
                ...
                .state('product', {
                    url: '/product',
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/product/product-list.html',
                    controller: 'ProductListCtrl as vm'
                })
                .state('product-create', {
                    url: '/product-create',
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/product/product-form.html',
                ...
                .state('product-translation', {
                    ...
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/product/product-translation-form.html',
                    controller: 'ProductTranslationFormCtrl as vm'
                })
                .state('widget-product-create', {
                    url: '/widget-product/create',
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/product-widget/product-widget-form.html',
                ...
                .state('widget-category-create', {
                    ...
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/category-widget/category-widget-form.html',
                ...
                .state('widget-simple-product-create', {
                    ...
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/simple-product-widget/simple-product-widget-form.html',
                ...
                .state('product-prices', {
                    url: '/product-prices',
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/product-price/product-price-form.html',
                    controller: 'ProductPriceFormCtrl as vm'
                })
                .state('product-clone', {
                    url: '/product-clone/:id',
                    templateUrl: '_content/NhaHang.Module.Catalog/admin/product-clone/product-clone-form.html',
