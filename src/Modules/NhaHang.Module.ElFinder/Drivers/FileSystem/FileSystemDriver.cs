...
using NhaHang.Module.ElFinder.Extensions;
using NhaHang.Module.ElFinder.Helpers;
using NhaHang.Module.ElFinder.Models;
using NhaHang.Module.ElFinder.Models.Commands;
...
namespace NhaHang.Module.ElFinder.Drivers.FileSystem
{
    /// <summary>
    ...
    public class FileSystemDriver : BaseDriver, IDriver
    {
        ...
        /// <summary>
        /// Initialize new instance of class NhaHang.Module.ElFinder.FileSystemDriver
        /// </summary>
        public FileSystemDriver(/*IRepository<Media> _repositoryMedia*/)
        {
            ///this._repositoryMedia = _repositoryMedia;
