...
{
    // For a list of all possible error messages: https://github.com/Studio-42/NhaHang.Module.ElFinder/blob/master/js/i18n/NhaHang.Module.ElFinder.en.js
    ...
    public static class Error
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static JsonResult ThreadsToRuning()
        {
            return FormatSimpleError("ThreadsToRuning"); // old name - errFileMaxSize
        }
